...
> thường có UID từ 200 trở lên và có tên nhóm chính trùng với tên người dùng. Giá trị umask mặc định cho các người dùng khác, bao gồm
> cả người dùng root, là 0022. Red Hat Enterprise Linux 9 và các phiên bản sau này áp dụng thống nhất giá trị umask mặc định là 0022
> cho tất cả người dùng, trong cả shell đăng nhập (login shell) và shell không đăng nhập (non-login shell). RHEL 9 và các phiên bản
> mới hơn không còn áp dụng các ngoại lệ đối với thiết lập umask mặc định dựa trên ID người dùng hay sự trùng khớp tên nhóm; điều này
> giúp tăng tính nhất quán và đơn giản hóa các yêu cầu về bảo mật.
