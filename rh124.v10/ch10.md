...
> **Quan trọng**: Việc sử dụng tùy chọn `-g` để thay đổi nhóm chính mặc định của người dùng sẽ không tự động thêm nhóm chính cũ vào
> danh sách các nhóm phụ của người dùng đó. Bạn có thể thấy cơ chế hoạt động này trong ví dụ trước đó. Ngoài ra, việc sử dụng tùy chọn
> này không làm thay đổi quyền sở hữu nhóm đối với bất kỳ tệp tin nào hiện có trong thư mục chính (home directory) của người dùng hoặc
> tại các vị trí khác trên hệ thống.
