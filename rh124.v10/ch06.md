...
Ở đầu danh sách hiển thị là hai thư mục đặc biệt. Một dấu chấm (`.`) đại diện cho thư mục hiện tại, còn hai dấu chấm (`..`) đại diện
cho thư mục cha. Các thư mục đặc biệt này tồn tại trong mọi thư mục trên hệ thống và rất hữu ích khi sử dụng các lệnh quản lý tệp tin.
